...
class LSDBFormatListener(FormatListener):
    ...
    def enterCircle(self, ctx):
        ...
        try:
            ...
            raise ValueError("Invalid values in CIRCLE") from e
    ...
    def enterPolygon(self, ctx):
        ...
        try:
            ...
            raise ValueError("Invalid values in POLYGON") from e
            ...
            for limit_text in self.limit_contexts.values():
                ...
                if match:
                    try:
                        ...
                        raise ValueError("Invalid TOP/LIMIT value") from e
        ...
        for keyword in unsupported_keywords:
            if keyword in from_text:
                raise NotImplementedError(
                    f"Unsupported SQL construct '{keyword}' found in FROM clause. "
                    "Only simple FROM table_name is supported."
                )
    ...
    def get_entities(self):
        """Return the entities parsed from the ADQL."""
...
def main():
    """Parse command-line arguments and run adql_to_lsdb() on the given input."""
